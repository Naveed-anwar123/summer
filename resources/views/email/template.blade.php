            ...
            {{--<td valign="top" class="mcnTextBlockInner" style="padding-top:9px;">--}}
                ...
                {{--<table align="left" border="0" cellpadding="0" cellspacing="0" style="max-width:100%; min-width:100%;" width="100%" class="mcnTextContentContainer">--}}
                    {{--<tbody><tr>--}}
                        ...
                        {{----}}
                            {{--<div style="text-align: left;"><h4>You received email from laravel using mailgun.</h4></div>--}}
                    ...
                    {{--<tbody>--}}
                        {{--<tr>--}}
                            {{--<td align="center" valign="middle" class="mcnButtonContent" style="font-family: Arial; font-size: 16px; padding: 15px;">--}}
                                {{--<a class="mcnButton " title="Visit our Site" href="http://" target="_blank" style="font-weight: bold;letter-spacing: normal;line-height: 100%;text-align: center;text-decoration: none;color: #FFFFFF;">Visit our Site</a>--}}
                            {{--</td>--}}
                        {{--</tr>--}}
                    {{--</tbody>--}}
                {{--</table>--}}
                                                                ...
                                                                {{--<td align="left" valign="middle" style="padding-top:5px; padding-right:10px; padding-bottom:5px; padding-left:9px;">--}}
                                                                    {{--<table align="left" border="0" cellpadding="0" cellspacing="0" width="">--}}
                                                                        {{--<tbody><tr>--}}
                                                                            {{----}}
                                                                                {{--<td align="center" valign="middle" width="24" class="mcnFollowIconContent">--}}
                                                                                    {{--<a href="http://www.yourwebsite.com" target="_blank"><img src="https://cdn-images.mailchimp.com/icons/social-block-v2/color-link-48.png" style="display:block;" height="24" width="24" class=""></a>--}}
                                                                                {{--</td>--}}
                                                                            {{----}}
                                                                            {{----}}
                                                                        {{--</tr>--}}
